...
import com.moneytransfer.accounts.model.Account
...
class GetAccountUseCase(private val journalsRepo: AccountRepository) :
    ...
    override fun execute(): LiveData<Result<List<HomeItem>>> {
        ...
        launch {
            val toPost = when (val response = journalsRepo.getAccounts()) {
